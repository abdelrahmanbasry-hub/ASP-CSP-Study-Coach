  ...
  return (
    <main className="homework-runner">
      ...
      <section className="homework-question-card">
        ...
        <QuestionVisualAid id={current.id} stem={current.stem} topic={chapter?.courseTitle} />
        <h1>{current.stem}</h1>
