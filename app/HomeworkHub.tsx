  ...
  return (
    <main className="homework-runner">
      ...
      <section className="homework-question-card">
        ...
        <QuestionVisualAid key={current.id} id={current.id} stem={current.stem} topic={chapter?.courseTitle} />
        <h1>{current.stem}</h1>
