...
export const HAZARD_CATEGORIES = [
  ...
  { id: "chemical-hazmat", name: { en: "Chemical & HazMat", ar: "المواد الكيميائية والمواد الخطرة" }, icon: "flask", placement: "primary", subcategories: finalSubcategories("CHEM") },
  ...
  { id: "ergonomics-human-factors", name: { en: "Ergonomics / Human Factors", ar: "العوامل البشرية وملاءمة بيئة العمل" }, icon: "person", placement: "primary", subcategories: finalSubcategories("ERGO") },
  ...
  { id: "hazardous-energy", name: { en: "LOTO / Hazardous Energy", ar: "الطاقة الخطرة (القفل والوسم)" }, icon: "lock", placement: "more", subcategories: finalSubcategories("LOTO") },
  { id: "pressure-systems", name: { en: "Pressure / Hydraulic / Pneumatic", ar: "أنظمة الضغط والهيدروليك والهواء المضغوط" }, icon: "gauge", placement: "more", subcategories: finalSubcategories("PRESS") },
  ...
  { id: "environmental", name: { en: "Environmental", ar: "المخاطر البيئية" }, icon: "leaf", placement: "more", subcategories: finalSubcategories("ENV") },
  { id: "security-emergency", name: { en: "Security / Emergency", ar: "الأمن والاستجابة للطوارئ" }, icon: "shield", placement: "more", subcategories: finalSubcategories("SEC") },
